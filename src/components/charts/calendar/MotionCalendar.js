    ...
    render() {
        ...
        return (
            <g>
                ...
                <TransitionMotion
                    styles={monthLegendStyles({ months, direction, monthLegendOffset, stiffness, damping })}
                >
                    {interpolatedStyles => (
                        <g>
                            {interpolatedStyles.map(d => (
                ...
                <TransitionMotion
                    styles={yearLegendStyles({ years, direction, yearLegendOffset, stiffness, damping })}
                >
                    {interpolatedStyles => (
                        <g>
                            {interpolatedStyles.map(d => (
