...
class RadialStack extends Component {
    shouldComponentUpdate(nextProps) {
        this.radialStack.decorate(decoratorsFromReactChildren(nextProps.children, RADIAL_STACK_DECORATOR));
        this.radialStack.draw(_.assign({}, nextProps, {
    ...
    componentDidMount() {
        ...
        this.radialStack.decorate(decoratorsFromReactChildren(this.props.children, RADIAL_STACK_DECORATOR));
        this.radialStack.draw(_.assign({}, this.props, {
