...
const props: ChartProperty[] = [
    ...
    },
    {
        ...
        flavors: ['svg'],
        group: 'Interactivity',
        help: `onTouchStart handler, requires useMesh and slices disabled.`,
        type: '(point, event) => void',
        required: false,
    },
    {
        ...
        flavors: ['svg'],
        group: 'Interactivity',
        help: `onTouchMove handler, requires useMesh and slices disabled.`,
        type: '(point, event) => void',
        required: false,
    },
    {
        ...
        flavors: ['svg'],
        group: 'Interactivity',
        help: `onTouchEnd handler, requires useMesh and slices disabled.`,
        type: '(point, event) => void',
        required: false,
    },
    {
