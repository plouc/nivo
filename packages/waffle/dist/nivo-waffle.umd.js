(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('lodash.partial'), require('react-motion'), require('recompose/setDisplayName'), require('@bitbloom/nivo-core'), require('@bitbloom/nivo-legends'), require('prop-types'), require('@bitbloom/nivo-colors'), require('recompose/pure'), require('recompose/compose'), require('recompose/defaultProps'), require('recompose/withPropsOnChange'), require('recompose/withState'), require('lodash.range'), require('@bitbloom/nivo-tooltip')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'lodash.partial', 'react-motion', 'recompose/setDisplayName', '@bitbloom/nivo-core', '@bitbloom/nivo-legends', 'prop-types', '@bitbloom/nivo-colors', 'recompose/pure', 'recompose/compose', 'recompose/defaultProps', 'recompose/withPropsOnChange', 'recompose/withState', 'lodash.range', '@bitbloom/nivo-tooltip'], factory) :
...
}(this, (function (exports, React, partial, reactMotion, setDisplayName, nivoCore, nivoLegends, PropTypes, nivoColors, pure, compose, defaultProps, withPropsOnChange, withState, range, nivoTooltip) { 'use strict';
