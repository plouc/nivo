...
stories.add('default', withInfo()(() => <Radar {...commonProperties} />))

stories.add(
    'with custom curve',
    withInfo()(() => <Radar {...commonProperties} gridShape="linear" curve="catmullRomClosed" />)
)
...
stories.add(
    ...
    withInfo()(() => <Radar {...commonProperties} gridLabel={LabelComponent} />)
)
