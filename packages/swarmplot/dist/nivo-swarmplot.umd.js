(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@bitbloom/nivo-core'), require('@bitbloom/nivo-colors'), require('@bitbloom/nivo-axes'), require('@bitbloom/nivo-voronoi'), require('prop-types'), require('@bitbloom/nivo-scales'), require('@bitbloom/nivo-annotations'), require('lodash/get'), require('@bitbloom/nivo-tooltip'), require('lodash/isString'), require('lodash/isNumber'), require('lodash/isPlainObject'), require('d3-scale'), require('d3-force'), require('react-motion')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@bitbloom/nivo-core', '@bitbloom/nivo-colors', '@bitbloom/nivo-axes', '@bitbloom/nivo-voronoi', 'prop-types', '@bitbloom/nivo-scales', '@bitbloom/nivo-annotations', 'lodash/get', '@bitbloom/nivo-tooltip', 'lodash/isString', 'lodash/isNumber', 'lodash/isPlainObject', 'd3-scale', 'd3-force', 'react-motion'], factory) :
...
}(this, (function (exports, React, nivoCore, nivoColors, nivoAxes, nivoVoronoi, PropTypes, nivoScales, nivoAnnotations, get, nivoTooltip, isString, isNumber, isPlainObject, d3Scale, d3Force, reactMotion) { 'use strict';
  ...
  var commonPropTypes = {
    ...
    valueScale: nivoScales.scalePropType.isRequired,
  ...
  var computeValueScale = function computeValueScale(_ref) {
    ...
    if (scale.type === 'time') {
      ...
      var axes = nivoScales.generateSeriesAxis(series, axis, scale);
      return nivoScales.computeScale(_objectSpread2(_objectSpread2({}, scale), {}, {
        axis: axis
  ...
  var getParsedValue = function getParsedValue(scaleSpec) {
    if (scaleSpec.type === 'linear') {
      ...
      return nivoScales.createDateNormalizer(scaleSpec);
    } else {
      return function (x) {
        return x;
      };
    ...
    return React__default.createElement(reactMotion.TransitionMotion, {
      ...
      styles: nodes.map(function (node) {
        return {
          ...
          }, nivoColors.interpolateColor(node.color, springConfig)), {}, {
  ...
  var SwarmPlot = React.memo(function (_ref) {
    ...
    if (isInteractive === true && useMesh === true) {
      layerById.mesh = React__default.createElement(nivoVoronoi.Mesh, {
        key: "mesh",
        nodes: nodes,
        width: innerWidth,
        height: innerHeight,
  ...
  var SwarmPlot$1 = nivoCore.withContainer(SwarmPlot);
  ...
  var SwarmPlotCanvas = React.memo(function (_ref2) {
    ...
    var _useSwarmPlot = useSwarmPlot({
      ...
      simulationIterations: simulationIterations
        ...
        yScale = _useSwarmPlot.yScale;
    var boundAnnotations = useSwarmPlotAnnotations(nodes, annotations);
    var computedAnnotations = nivoAnnotations.useComputedAnnotations({
  ...
  var SwarmPlotCanvas$1 = nivoCore.withContainer(SwarmPlotCanvas);
