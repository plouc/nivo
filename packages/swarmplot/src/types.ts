...
import { PropertyAccessor, ValueFormat, Theme, MotionProps, Box, Margin } from '@bitbloom/nivo-core'
...
import { ScaleLinear, ScaleLinearSpec, ScaleTime, ScaleTimeSpec, TicksSpec } from '@bitbloom/nivo-scales'
