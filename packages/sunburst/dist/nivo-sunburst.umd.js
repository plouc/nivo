(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('lodash/sortBy'), require('lodash/cloneDeep'), require('recompose/compose'), require('recompose/defaultProps'), require('recompose/withPropsOnChange'), require('recompose/withProps'), require('recompose/pure'), require('d3-hierarchy'), require('d3-shape'), require('@bitbloom/nivo-core'), require('@bitbloom/nivo-colors'), require('@bitbloom/nivo-tooltip')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'lodash/sortBy', 'lodash/cloneDeep', 'recompose/compose', 'recompose/defaultProps', 'recompose/withPropsOnChange', 'recompose/withProps', 'recompose/pure', 'd3-hierarchy', 'd3-shape', '@bitbloom/nivo-core', '@bitbloom/nivo-colors', '@bitbloom/nivo-tooltip'], factory) :
...
}(this, (function (exports, React, sortBy, cloneDeep, compose, defaultProps, withPropsOnChange, withProps, pure, d3Hierarchy, d3Shape, nivoCore, nivoColors, nivoTooltip) { 'use strict';
