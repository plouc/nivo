(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@bitbloom/nivo-core'), require('prop-types'), require('@bitbloom/nivo-colors'), require('react-spring'), require('lodash/get'), require('lodash/omit'), require('lodash/cloneDeep'), require('lodash/startCase'), require('d3-hierarchy'), require('@bitbloom/nivo-tooltip')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@bitbloom/nivo-core', 'prop-types', '@bitbloom/nivo-colors', 'react-spring', 'lodash/get', 'lodash/omit', 'lodash/cloneDeep', 'lodash/startCase', 'd3-hierarchy', '@bitbloom/nivo-tooltip'], factory) :
...
}(this, (function (exports, React, nivoCore, PropTypes, nivoColors, reactSpring, get, omit, cloneDeep, startCase, d3Hierarchy, nivoTooltip) { 'use strict';
