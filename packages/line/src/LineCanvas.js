...
const LineCanvas = ({
        ...
        layers.forEach(layer => {
            ...
            if (layer === 'lines') {
                ...
                series.forEach(serie => {
                    ...
                    ctx.lineWidth = currentPoint && currentPoint.serieId === serie.id ? 2 : 1
                    ctx.beginPath()
            ...
            if (layer === 'points' && enablePoints === true && pointSize > 0) {
                points.forEach(point => {
                    ...
                    ctx.arc(
                        point.x,
                        point.y,
                        (currentPoint && currentPoint.index === point.index
                            ? pointSize * 3
                            : pointSize) / 2,
                        0,
                        2 * Math.PI
    ...
    const handleMouseHover = useCallback(
        ...
        [getPointFromMouseEvent, setCurrentPoint, showTooltip, hideTooltip]
    )
