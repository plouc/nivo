(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@bitbloom/nivo-core'), require('@bitbloom/nivo-colors'), require('@bitbloom/nivo-axes'), require('@bitbloom/nivo-legends'), require('@bitbloom/nivo-tooltip'), require('d3-shape'), require('@bitbloom/nivo-scales'), require('prop-types'), require('react-spring'), require('@bitbloom/nivo-voronoi')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@bitbloom/nivo-core', '@bitbloom/nivo-colors', '@bitbloom/nivo-axes', '@bitbloom/nivo-legends', '@bitbloom/nivo-tooltip', 'd3-shape', '@bitbloom/nivo-scales', 'prop-types', 'react-spring', '@bitbloom/nivo-voronoi'], factory) :
...
}(this, (function (exports, React, nivoCore, nivoColors, nivoAxes, nivoLegends, nivoTooltip, d3Shape, nivoScales, PropTypes, reactSpring, nivoVoronoi) { 'use strict';
  ...
  var commonPropTypes = {
    ...
    areaBlendMode: nivoCore.blendModePropType.isRequired,
    ...
    crosshairType: nivoTooltip.crosshairPropTypes.type.isRequired
  };
  var LinePropTypes = _objectSpread2(_objectSpread2(_objectSpread2({}, commonPropTypes), {}, {
    enablePointLabel: PropTypes.bool.isRequired,
    role: PropTypes.string.isRequired,
    useMesh: PropTypes.bool.isRequired
  }, nivoCore.motionPropTypes), nivoCore.defsPropTypes);
  ...
  var useAreaGenerator = function useAreaGenerator(_ref2) {
    ...
    return React.useMemo(function () {
      return d3Shape.area().defined(function (d) {
        ...
        return d.y;
      }).curve(nivoCore.curveFromProp(curve)).y0(yScale(areaBaselineValue));
  ...
  var Points = function Points(_ref) {
    ...
    var theme = nivoCore.useTheme();
    var getLabel = nivoCore.getLabelGenerator(label);
  ...
  var Mesh = function Mesh(_ref) {
    ...
    var handleMouseEnter = React.useCallback(function (point, event) {
      showTooltipAt(React__default.createElement(tooltip, {
        point: point
  ...
  var Line = function Line(props) {
    ...
    var boundDefs = nivoCore.bindDefs(defs, series, fill);
    if (enableArea) {
    ...
    if (isInteractive && enableCrosshair) {
      if (currentPoint !== null) {
        layerById.crosshair = React__default.createElement(nivoTooltip.Crosshair, {
          key: "crosshair",
          width: innerWidth,
          height: innerHeight,
          x: currentPoint.x,
  ...
  var Line$1 = nivoCore.withContainer(Line);
    ...
    React.useEffect(function () {
      ...
      layers.forEach(function (layer) {
        ...
        if (layer === 'mesh' && debugMesh === true) {
          ...
          if (currentPoint) {
            nivoVoronoi.renderVoronoiCellToCanvas(ctx, voronoi, currentPoint.index);
          }
        }
        if (layer === 'legends') {
  ...
  var LineCanvas$1 = nivoCore.withContainer(LineCanvas);
