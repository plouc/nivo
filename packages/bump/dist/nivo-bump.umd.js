(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@bitbloom/nivo-core'), require('@bitbloom/nivo-axes'), require('d3-shape'), require('@bitbloom/nivo-colors'), require('@bitbloom/nivo-tooltip'), require('d3-scale'), require('prop-types'), require('react-spring')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@bitbloom/nivo-core', '@bitbloom/nivo-axes', 'd3-shape', '@bitbloom/nivo-colors', '@bitbloom/nivo-tooltip', 'd3-scale', 'prop-types', 'react-spring'], factory) :
...
}(this, (function (exports, React, nivoCore, nivoAxes, d3Shape, nivoColors, nivoTooltip, d3Scale, PropTypes, reactSpring) { 'use strict';
