(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-spring'), require('@bitbloom/nivo-core'), require('d3-time'), require('d3-time-format'), require('d3-format'), require('prop-types')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-spring', '@bitbloom/nivo-core', 'd3-time', 'd3-time-format', 'd3-format', 'prop-types'], factory) :
...
}(this, (function (exports, React, reactSpring, nivoCore, d3Time, d3TimeFormat, d3Format, PropTypes) { 'use strict';
  ...
  var computeCartesianTicks = function computeCartesianTicks(_ref) {
    ...
    var textProps = nivoCore.textPropsByEngine[engine];
