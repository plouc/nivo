(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@bitbloom/nivo-core'), require('@bitbloom/nivo-colors'), require('@bitbloom/nivo-tooltip'), require('prop-types'), require('lodash/get'), require('lodash/isString'), require('lodash/isNumber'), require('d3-force'), require('react-motion')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@bitbloom/nivo-core', '@bitbloom/nivo-colors', '@bitbloom/nivo-tooltip', 'prop-types', 'lodash/get', 'lodash/isString', 'lodash/isNumber', 'd3-force', 'react-motion'], factory) :
...
}(this, (function (exports, React, nivoCore, nivoColors, nivoTooltip, PropTypes, get, isString, isNumber, d3Force, reactMotion) { 'use strict';
