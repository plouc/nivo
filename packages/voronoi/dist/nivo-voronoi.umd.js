(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@bitbloom/nivo-core'), require('d3-scale'), require('d3-delaunay'), require('recompose/compose'), require('recompose/defaultProps'), require('recompose/withPropsOnChange'), require('recompose/pure'), require('prop-types')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', '@bitbloom/nivo-core', 'd3-scale', 'd3-delaunay', 'recompose/compose', 'recompose/defaultProps', 'recompose/withPropsOnChange', 'recompose/pure', 'prop-types'], factory) :
...
}(this, (function (exports, React, nivoCore, d3Scale, d3Delaunay, compose, defaultProps, withPropsOnChange, pure, PropTypes) { 'use strict';
    ...
    var enhance = (function (Component) {
      return compose(defaultProps(VoronoiDefaultProps), nivoCore.withTheme(), nivoCore.withDimensions(), withPropsOnChange(['xDomain', 'yDomain', 'width', 'height'], function (_ref) {
    ...
    var Voronoi = function Voronoi(_ref) {
      ...
      return React__default.createElement(nivoCore.Container, {
        ...
        return (
          React__default.createElement(nivoCore.SvgWrapper, {
            width: outerWidth,
            height: outerHeight,
            margin: margin,
            theme: theme
    ...
    var Mesh = function Mesh(_ref) {
      ...
      var getIndexAndNodeFromEvent = React.useCallback(function (event) {
        var _getRelativeCursor = nivoCore.getRelativeCursor(elementRef.current, event),
