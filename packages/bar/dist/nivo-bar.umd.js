(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-motion'), require('@bitbloom/nivo-core'), require('@bitbloom/nivo-axes'), require('@bitbloom/nivo-legends'), require('lodash/min'), require('lodash/max'), require('lodash/range'), require('d3-scale'), require('lodash/flattenDepth'), require('d3-shape'), require('lodash'), require('recompose/setDisplayName'), require('recompose'), require('recompose/defaultProps'), require('recompose/withPropsOnChange'), require('recompose/pure'), require('@bitbloom/nivo-colors'), require('prop-types'), require('recompose/compose'), require('@bitbloom/nivo-tooltip'), require('@bitbloom/nivo-annotations'), require('lodash/uniqBy')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-motion', '@bitbloom/nivo-core', '@bitbloom/nivo-axes', '@bitbloom/nivo-legends', 'lodash/min', 'lodash/max', 'lodash/range', 'd3-scale', 'lodash/flattenDepth', 'd3-shape', 'lodash', 'recompose/setDisplayName', 'recompose', 'recompose/defaultProps', 'recompose/withPropsOnChange', 'recompose/pure', '@bitbloom/nivo-colors', 'prop-types', 'recompose/compose', '@bitbloom/nivo-tooltip', '@bitbloom/nivo-annotations', 'lodash/uniqBy'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.ReactMotion, global.nivo, global.nivo, global.nivo, global['lodash/min'], global['lodash/max'], global['lodash/range'], global.d3, global['lodash/flattenDepth'], global.d3, global.lodash, global.RecomposeSetDisplayName, global.Recompose, global.RecomposeDefaultProps, global.RecomposeWithPropsOnChange, global.RecomposePure, global.nivo, global.PropTypes, global.RecomposeCompose, global.nivo, global.nivo, global['lodash/uniqBy']));
}(this, (function (exports, React, reactMotion, nivoCore, nivoAxes, nivoLegends, min, max, range, d3Scale, flattenDepth, d3Shape, lodash, setDisplayName, recompose, defaultProps, withPropsOnChange, pure, nivoColors, PropTypes, compose, nivoTooltip, nivoAnnotations, uniqBy) { 'use strict';
