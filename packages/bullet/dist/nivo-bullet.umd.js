(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('d3-scale'), require('recompose/setDisplayName'), require('@bitbloom/nivo-core'), require('prop-types'), require('lodash/isString'), require('react-motion'), require('lodash/partial'), require('recompose/compose'), require('recompose/defaultProps'), require('recompose/withPropsOnChange'), require('recompose/pure'), require('@bitbloom/nivo-axes'), require('@bitbloom/nivo-tooltip'), require('lodash/last'), require('@bitbloom/nivo-colors')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'd3-scale', 'recompose/setDisplayName', '@bitbloom/nivo-core', 'prop-types', 'lodash/isString', 'react-motion', 'lodash/partial', 'recompose/compose', 'recompose/defaultProps', 'recompose/withPropsOnChange', 'recompose/pure', '@bitbloom/nivo-axes', '@bitbloom/nivo-tooltip', 'lodash/last', '@bitbloom/nivo-colors'], factory) :
...
}(this, (function (exports, React, d3Scale, setDisplayName, nivoCore, PropTypes, isString, reactMotion, partial, compose, defaultProps, withPropsOnChange, pure, nivoAxes, nivoTooltip, last, nivoColors) { 'use strict';
