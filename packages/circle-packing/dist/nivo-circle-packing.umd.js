(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-motion'), require('lodash/pick'), require('@bitbloom/nivo-core'), require('@bitbloom/nivo-colors'), require('d3-hierarchy'), require('recompose/compose'), require('recompose/defaultProps'), require('recompose/withPropsOnChange'), require('recompose/withStateHandlers'), require('recompose/pure'), require('prop-types'), require('@bitbloom/nivo-tooltip')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-motion', 'lodash/pick', '@bitbloom/nivo-core', '@bitbloom/nivo-colors', 'd3-hierarchy', 'recompose/compose', 'recompose/defaultProps', 'recompose/withPropsOnChange', 'recompose/withStateHandlers', 'recompose/pure', 'prop-types', '@bitbloom/nivo-tooltip'], factory) :
...
}(this, (function (exports, React, reactMotion, pick, nivoCore, nivoColors, d3Hierarchy, compose, defaultProps, withPropsOnChange, withStateHandlers, pure, PropTypes, nivoTooltip) { 'use strict';
  ...
  var commonEnhancers = [nivoCore.withHierarchy(), nivoCore.withDimensions(), nivoCore.withTheme(), withPropsOnChange(['colors', 'colorBy'], function (_ref) {
  ...
  var svgEnhancers = [withPropsOnChange(['nodes', 'defs', 'fill'], function (_ref12) {
    var nodes = _ref12.nodes,
        ...
        fill = _ref12.fill;
    return {
      defs: nivoCore.bindDefs(defs, nodes, fill, {
        targetKey: 'fill'
      })
    };
  })];
  var enhance = (function (Component) {
    ...
    switch (Component.displayName) {
      case 'Bubble':
        return compose.apply(void 0, [defaultProps(implDefaultProps)].concat(commonEnhancers, svgEnhancers, [nivoCore.withMotion(), pure]))(Component);
      case 'BubbleHtml':
  ...
  var nodeWillEnter = function nodeWillEnter(_ref) {
    ...
    return _objectSpread2({
      ...
      x: data.x,
      y: data.y
    }, nivoColors.interpolateColor(data.color));
  };
  var nodeWillLeave = function nodeWillLeave(springConfig) {
    return function (_ref2) {
      ...
      }, nivoColors.interpolateColor(data.color, springConfig));
    };
  };
      ...
      return React__default.createElement(nivoCore.SvgWrapper, {
        ...
        return React__default.createElement("g", null, interpolatedStyles.map(function (_ref3) {
          var style = _ref3.style,
              node = _ref3.data;
          style.color = nivoColors.getInterpolatedColor(style);
          return React__default.createElement(nodeComponent, {
            key: node.path,
            node: node,
