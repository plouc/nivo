...
declare module '@nivo/beeswarm' {
    ...
    export interface BeeSwarmSvgProps extends BeeSwarmProps, MotionProps {}

    export class BeeSwarm extends React.Component<BeeSwarmSvgProps & Dimensions> {}
    export class ResponsiveBeeSwarm extends React.Component<BeeSwarmSvgProps> {}
