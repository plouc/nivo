...
import { useTheme, guessQuantizeColorScale, quantizeColorScalePropType, withContainer, useDimensions, SvgWrapper, ResponsiveWrapper, getRelativeCursor } from '@bitbloom/nivo-core';
...
import { useQuantizeColorScaleLegendData, BoxLegendSvg, renderLegendToCanvas } from '@bitbloom/nivo-legends';
...
var useChoropleth = function useChoropleth(_ref2) {
  ...
  var findMatchingDatum = useMemo(function () {
    ...
    return function (feature, datum) {
      var featureKey = get(feature, match);
      var datumKey = get(datum, match);
      return featureKey && featureKey === datumKey;
    };
  }, [match]);
  var getLabel = useMemo(function () {
    return isFunction(label) ? label : function (datum) {
      return get(datum, label);
    };
  }, [label]);
  var getValue = useMemo(function () {
    return isFunction(value) ? value : function (datum) {
      return get(datum, value);
    };
  }, [value]);
