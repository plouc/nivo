(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@bitbloom/nivo-core'), require('@bitbloom/nivo-tooltip'), require('prop-types'), require('@bitbloom/nivo-colors'), require('lodash'), require('d3-format'), require('d3-geo'), require('@bitbloom/nivo-legends')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@bitbloom/nivo-core', '@bitbloom/nivo-tooltip', 'prop-types', '@bitbloom/nivo-colors', 'lodash', 'd3-format', 'd3-geo', '@bitbloom/nivo-legends'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.nivo, global.nivo, global.PropTypes, global.nivo, global.lodash, global.d3, global.d3, global.nivo));
}(this, (function (exports, React, nivoCore, nivoTooltip, PropTypes, nivoColors, lodash, d3Format, d3Geo, nivoLegends) { 'use strict';
