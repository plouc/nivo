(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('lodash/isPlainObject'), require('lodash/filter'), require('lodash/omit'), require('@bitbloom/nivo-core'), require('react-spring')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'lodash/isPlainObject', 'lodash/filter', 'lodash/omit', '@bitbloom/nivo-core', 'react-spring'], factory) :
...
}(this, (function (exports, React, PropTypes, isPlainObject, filter, omit, nivoCore, reactSpring) { 'use strict';
    ...
    var getLinkAngle = function getLinkAngle(sourceX, sourceY, targetX, targetY) {
      ...
      return nivoCore.absoluteAngleDegrees(nivoCore.radiansToDegrees(angle));
    };
    var computeAnnotation = function computeAnnotation(_ref2) {
      ...
      if (type === 'circle') {
        var position = nivoCore.positionFromAngle(nivoCore.degreesToRadians(angle), size / 2);
