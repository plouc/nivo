(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@bitbloom/nivo-tooltip'), require('prop-types'), require('lodash/merge'), require('lodash/get'), require('lodash/set'), require('lodash/last'), require('lodash/isArray'), require('lodash/isString'), require('d3-scale'), require('d3-scale-chromatic'), require('lodash/isFunction'), require('lodash/without'), require('d3-shape'), require('d3-hierarchy'), require('d3-format'), require('d3-time-format'), require('lodash'), require('react-spring'), require('recompose/withProps'), require('lodash/isEqual'), require('recompose/compose'), require('recompose/setPropTypes'), require('recompose/defaultProps'), require('recompose/withPropsOnChange'), require('lodash/isPlainObject'), require('lodash/pick')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@bitbloom/nivo-tooltip', 'prop-types', 'lodash/merge', 'lodash/get', 'lodash/set', 'lodash/last', 'lodash/isArray', 'lodash/isString', 'd3-scale', 'd3-scale-chromatic', 'lodash/isFunction', 'lodash/without', 'd3-shape', 'd3-hierarchy', 'd3-format', 'd3-time-format', 'lodash', 'react-spring', 'recompose/withProps', 'lodash/isEqual', 'recompose/compose', 'recompose/setPropTypes', 'recompose/defaultProps', 'recompose/withPropsOnChange', 'lodash/isPlainObject', 'lodash/pick'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.nivo, global.PropTypes, global['lodash/merge'], global['lodash/get'], global['lodash/set'], global['lodash/last'], global['lodash/isArray'], global['lodash/isString'], global.d3, global.d3, global['lodash/isFunction'], global['lodash/without'], global.d3, global.d3, global.d3, global.d3, global.lodash, global['react-spring'], global.RecomposeWithProps, global['lodash/isEqual'], global.RecomposeCompose, global.RecomposeSetPropTypes, global.RecomposeDefaultProps, global.RecomposeWithPropsOnChange, global['lodash/isPlainObject'], global['lodash/pick']));
}(this, (function (exports, React, nivoTooltip, PropTypes, merge, get, set, last, isArray, isString, d3Scale, d3ScaleChromatic, isFunction, without, d3Shape, d3Hierarchy, d3Format, d3TimeFormat, lodash, reactSpring, withProps, isEqual, compose, setPropTypes, defaultProps, withPropsOnChange, isPlainObject, pick) { 'use strict';
  ...
  var MotionConfigProvider = function MotionConfigProvider(_ref) {
    ...
    var value = React.useMemo(function () {
      var reactSpringConfig = lodash.isString(config) ? reactSpring.config[config] : config;
      return {
        animate: animate,
        springConfig: {
          stiffness: stiffness,
  ...
  var Container = function Container(_ref) {
    ...
    }, React__default.createElement(nivoTooltip.tooltipContext.Provider, {
  ...
  var Container$1 = function Container(_ref) {
    ...
    var _useTooltipHandlers = nivoTooltip.useTooltipHandlers(container),
    ...
    return React__default.createElement(ThemeProvider, {
      ...
      ref: container
    }, children, isTooltipVisible && React__default.createElement(nivoTooltip.TooltipWrapper, {
  ...
  exports.defaultOverflow = defaultOverflow;
