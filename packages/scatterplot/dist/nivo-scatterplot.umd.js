(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@bitbloom/nivo-core'), require('@bitbloom/nivo-axes'), require('@bitbloom/nivo-legends'), require('@bitbloom/nivo-colors'), require('@bitbloom/nivo-scales'), require('@bitbloom/nivo-annotations'), require('lodash/get'), require('lodash/isString'), require('lodash/isNumber'), require('lodash/isPlainObject'), require('d3-scale'), require('prop-types'), require('@bitbloom/nivo-tooltip'), require('react-motion'), require('@bitbloom/nivo-voronoi')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@bitbloom/nivo-core', '@bitbloom/nivo-axes', '@bitbloom/nivo-legends', '@bitbloom/nivo-colors', '@bitbloom/nivo-scales', '@bitbloom/nivo-annotations', 'lodash/get', 'lodash/isString', 'lodash/isNumber', 'lodash/isPlainObject', 'd3-scale', 'prop-types', '@bitbloom/nivo-tooltip', 'react-motion', '@bitbloom/nivo-voronoi'], factory) :
...
}(this, (function (exports, React, nivoCore, nivoAxes, nivoLegends, nivoColors, nivoScales, nivoAnnotations, get, isString, isNumber, isPlainObject, d3Scale, PropTypes, nivoTooltip, reactMotion, nivoVoronoi) { 'use strict';
