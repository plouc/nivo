(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@bitbloom/nivo-core'), require('@bitbloom/nivo-colors'), require('@bitbloom/nivo-legends'), require('prop-types'), require('@bitbloom/nivo-tooltip'), require('d3-shape'), require('d3-chord'), require('lodash/mapValues'), require('react-motion')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@bitbloom/nivo-core', '@bitbloom/nivo-colors', '@bitbloom/nivo-legends', 'prop-types', '@bitbloom/nivo-tooltip', 'd3-shape', 'd3-chord', 'lodash/mapValues', 'react-motion'], factory) :
...
}(this, (function (exports, React, nivoCore, nivoColors, nivoLegends, PropTypes, nivoTooltip, d3Shape, d3Chord, mapValues, reactMotion) { 'use strict';
