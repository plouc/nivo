(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@bitbloom/nivo-core'), require('prop-types'), require('@bitbloom/nivo-colors'), require('@bitbloom/nivo-annotations'), require('d3-shape'), require('d3-scale'), require('@bitbloom/nivo-tooltip'), require('react-spring')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@bitbloom/nivo-core', 'prop-types', '@bitbloom/nivo-colors', '@bitbloom/nivo-annotations', 'd3-shape', 'd3-scale', '@bitbloom/nivo-tooltip', 'react-spring'], factory) :
...
}(this, (function (exports, React, nivoCore, PropTypes, nivoColors, nivoAnnotations, d3Shape, d3Scale, nivoTooltip, reactSpring) { 'use strict';
