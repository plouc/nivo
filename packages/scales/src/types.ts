...
export interface ScaleTypeToScale<Input extends ScaleValue, Output> {
...
export type Scale<Input extends ScaleValue, Output> = ScaleTypeToScale<Input, Output>[keyof ScaleTypeToScale<
    Input,
    Output
>]
