...
function Title() {
    ...
    const title = pathname
        ...
        .map(text => text.replace(/((^| )(.))/g, letter => letter.toUpperCase()))
...
function Welcome() {
    return (
        <div className={css({ fontSize: '1.2em', textAlign: 'center' })}>
            ...
            <br />
            <div>
                Here would be a great starting point to fork and create a reproduction for your bug
                report.
            </div>
            <br />
            <div>
                This example will also be built with every PR and make it easier to verify a bugfix
                or new feature.
            </div>
            <br />
            <div>
                You can get started by selecting the chart from the left side menu. You can find the
                charts in <code>src/charts</code> to modify to your needs.
            </div>
        </div>
    )
}
