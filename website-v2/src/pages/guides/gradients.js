        ...
        return (
            <GlobalLayout>
                <div className="inner-content">
                    ...
                    <div className="guide__description text-content">
                        <p>
                            <strong>Separating gradient definitions from application</strong> allows
                            us to reuse those in various places, like fills and borders, and while
                            maintaining a direct mapping for a bar chart with 5 items can be simple
                            enough, when you're dealing with a complex heatmap with tens of nodes it
                            can quickly become cumbersome. Doing so also provides the ability to{' '}
                            <strong>use a gradient depending on chart element value</strong>. Last
                            but not least, <strong>gradient colors can be inherited</strong> from
                            current node ones.
                        </p>
                        <h2>Example</h2>
                        <GradientsExample />
                        ...
                        <p>
                            ...
                            <strong>not supported for canvas</strong> chart implementations for now,
                            and tooltips involving colored chips will use plain element color.
                        </p>
                    </div>
                </div>
            </GlobalLayout>
