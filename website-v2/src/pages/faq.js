            ...
            <div className="inner-content">
                <div className="page_content">
                    ...
                    <div className="guide__description text-content">
                        ...
                        <p>
                            nivo provides quite high level components, so it should be used if you
                            have no prior experience with d3 or want a quick/easy setup. Also its
                            components can be easily tweaked by adjusting a few <i>knobs</i>, and
                            offers various flavors for each chart types.
                        </p>
